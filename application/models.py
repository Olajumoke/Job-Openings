...
class Questionnaire(models.Model):
	...
	Job_Salary = models.CharField(max_length=100, choices=STATUS, verbose_name="Can you live on N250,000 or less for the next 9 months?")
	Job_Time = models.CharField(max_length=100, choices=STATUS, verbose_name="I just want a 9-5 job to pay the bills")
	Told_What_to_do = models.CharField(max_length=100, choices=STATUS, verbose_name="I like to be told what to do")
	Entrepreneur = models.CharField(max_length=100, choices=STATUS, verbose_name="I am an entrepreneur at heart")
	Dislikes = models.CharField(max_length=100, choices=DISLIKES, verbose_name="Who do you dislike the most?")
	Get_along_with = models.CharField(max_length=100, choices=GENDER,verbose_name="Who do you get along with")
	Gay_people = models.CharField(max_length=100, choices=GAYCHOICES, verbose_name="Gay people are disgusting and should be put in jail")
	Muslims = models.CharField(max_length=100, choices=STATUS, verbose_name="I cannot stand muslims")
	Christians = models.CharField(max_length=100, choices=STATUS, verbose_name="Christians and others are infidels")
